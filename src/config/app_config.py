"""HybridRAG Application Configuration.

Central configuration dataclasses for the hybrid RAG system:
LightRAG settings, ingestion pipeline, search parameters, and system config.
"""
...
def load_config(config_path: Optional[str] = None) -> HybridRAGConfig:
    ...
    if config_path and Path(config_path).exists():
        ...
        with open(config_path, 'r') as f:
            config_dict = json.load(f)  # noqa: F841
